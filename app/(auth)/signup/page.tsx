...
export default function SignupPage() {
  ...
  return (
    <div>
      <div className="mb-7">
        <div className="text-[11px] uppercase tracking-[0.16em] text-muted">Create account</div>
        <h1 className="serif mt-2 text-4xl leading-tight">Make it yours.</h1>
        <p className="mt-2 text-sm text-ink-soft">Spin up a fresh workspace in seconds.</p>
      </div>
