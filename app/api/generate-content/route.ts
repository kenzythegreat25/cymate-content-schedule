...
NOTES FORMAT RULE: The notes field must be structured plain text with each section separated by a blank line. Never write it as one continuous paragraph. Use this order: (1) "Post at: [time]" (2) Designer direction or Reel script (3) "Q&A Replies:" followed by Q1 through Q5, each on its own line in the format "Q1: [likely comment or question] — A: [warm, genuine reply]" (4) Any additional reminders. Because this is a JSON string value, use the literal characters backslash-n to represent newlines so the JSON remains valid — do not insert actual line breaks inside the string. The consumer will render the backslash-n as real line breaks.
