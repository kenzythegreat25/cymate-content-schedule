...
IG CTAs: Soft and natural. Never include a URL. For booking: "Booking link in the comments." / "Drop a comment — booking link below." For general links: "Link in the comments." / "Details in the comments."
LinkedIn CTAs: Soft and contextual. Never include a URL. For booking: "Booking link in the comments." / "Happy to walk through this — booking link in the comments." / "Drop a comment or grab time — link in the comments." For general links: "Link in the comments." Never "message us directly."
...
Each object:
{
  ...
  "description": "Instagram static/reel: Structure the caption in clearly separated short blocks — NOT a continuous paragraph. Format exactly like this: [Line 1: Hook — one punchy sentence that stops the scroll] [blank line] [Line 2-4: Value — 2 to 3 short punchy sentences, each on its own line, max 10 words each. One idea per line. No run-ons.] [blank line] [Line 5: ONE primary ask — choose either a save nudge (e.g. 'Save this before your next campaign.') OR a direct interactive question (e.g. 'What's your biggest challenge with cold outreach right now?'). Never include both in the same caption. Vary which one you pick across the week's posts.] [blank line] [Line 6: Soft closing line — e.g. 'Link in the comments.' / 'Booking link in the comments.' Keep it short and natural; never include a URL; this is a closing action, not a second ask.] [blank line] [5 hashtags on their own line]. Carousels: clean 2-4 line summary caption using the same short-line format, then the interactive question, then hashtags. LinkedIn: 280-380 words, strong hook first line, story-driven, short paragraphs with line breaks, ends with a direct question to the reader, soft CTA, then 5 hashtags on their own line.",
