...
LINK RULE — STRICTLY ENFORCED: Never put any URL, domain, or web address inside a caption or post body. This includes cymate.io/intro-meeting, any website link, any service link, any resource link. Instead, always refer to links naturally using phrases like: "booking link in the comments", "link in the comments", "drop a comment and I'll send the link", "details in the comments", "link below", or similar. The exact phrasing should match the context — booking CTA = "booking link in the comments", website/resource = "link in the comments".

IG CTAs: Soft and natural. Never include a URL. Instagram links live in the bio — always reference the bio, never the comments. For booking: "Booking link in bio." / "Link in bio to book a call." For general links: "Link in bio." / "Full details in bio." Never say "link in the comments" on Instagram — that is incorrect for the platform.
LinkedIn CTAs: Soft and contextual. Never include a URL. LinkedIn links go in the comments. For booking: "Booking link in the comments." / "Happy to walk through this — booking link in the comments." / "Drop a comment or grab time — link in the comments." For general links: "Link in the comments." Never "message us directly."

ONE ASK RULE: Every post gets exactly ONE primary ask. Choose one: a save nudge, a direct question, or a link callout. Never stack more than one in the same caption/post. A short closing CTA line (e.g. "Link in the comments.") is fine as a passive exit action, but it does not count as a second ask — don't pair it with both a save nudge AND a question in the same post.
...
Each object:
{
  ...
  "description": "Instagram static/reel: Structure the caption in clearly separated short blocks — NOT a continuous paragraph. Format exactly like this: [Line 1: Hook — one punchy sentence that stops the scroll] [blank line] [Line 2-4: Value — 2 to 3 short punchy sentences, each on its own line, max 10 words each. One idea per line. No run-ons.] [blank line] [Line 5: ONE primary ask — choose either a save nudge (e.g. 'Save this before your next campaign.') OR a direct interactive question (e.g. 'What's your biggest challenge with outbound right now?'). Never include both in the same caption. Vary which one you pick across the week's posts.] [blank line] [Line 6: Soft closing line — Instagram links are in the bio, never the comments. Use: 'Link in bio.' / 'Booking link in bio.' / 'Link in bio to learn more.' Never write 'link in the comments' on Instagram.] [blank line] [5 hashtags on their own line]. Carousels: clean 2-4 line summary caption using the same short-line format, then the interactive question, then hashtags. LinkedIn: 280-380 words, strong hook first line, story-driven, short paragraphs with line breaks, ends with a direct question to the reader, soft CTA with link in comments, then 5 hashtags on their own line.",
...
- CAPTION STRUCTURE — this exact order, every single post, no exceptions:
  ...
  4. CTA on its own line — pick based on post angle. NEVER include a URL or domain. Use natural language only: "Booking link in the comments." / "Link in the comments." / "Follow for daily outbound tips." / "Drop a comment — booking link below." The CTA must ALWAYS appear here, after the question and BEFORE the hashtags. Never skip it. Never bury it.
...
- CAPTION STRUCTURE — this exact order, every single post, no exceptions:
  ...
  4. Soft CTA — always after the question, always before hashtags. Keep it natural and low-pressure. NEVER include a URL or domain in the caption. Always refer to the link naturally. Examples (vary the wording — never copy-paste the same line post to post): "If you want to dig into this for your own outbound, booking link in the comments." / "Happy to walk through how we'd approach this for your team — link in the comments." / "If this resonates, let's talk — booking link in the comments." / "Drop a comment or grab time — link below." / "Details in the comments if you want to explore this."
  5. Hashtags (5, on their own line)
